  ...
  return (
    <div className="grid min-w-0 gap-5 sm:gap-6">
      {items.map((item, index) => {
        ...
        return (
          <article key={item.question} className="panel min-w-0 rounded-[1.5rem] p-5 sm:p-7">
            <button
              type="button"
            ...
            >
              <span className="min-w-0 break-words text-[1.05rem] font-semibold text-slate-800 dark:text-slate-100">{item.question}</span>
