...
function createEnglishMessages(): SiteMessages {
  return {
    ...
    home: {
      meta: {
        title: "Technical website audits before release",
        description: "Audit SEO, UX, performance, accessibility, and release risk before every launch.",
      },
      hero: {
...
const esMap: Record<string, string> = {
  ...
  "Technical website audits before release": "Auditorias tecnicas web antes de cada release",
  "Audit SEO, UX, performance, accessibility, and release risk before every launch.":
    "Audita SEO, UX, rendimiento, accesibilidad y riesgo de release antes de cada lanzamiento.",
  ...
  "Technical SEO blockers": "Bloqueos de SEO tecnico",
  "Indexation and metadata gaps": "Huecos de indexacion y metadatos",
  "Users dropping on mobile": "Usuarios que abandonan en mobile",
  "Weak mobile UX hurts retention": "Una UX movil deficiente perjudica la retencion.",
  "Conversion loss per extra second": "Perdida de conversion por cada segundo extra",
  "Performance impacts revenue": "El rendimiento impacta en ingresos.",
  "SEO Audit": "Auditoria SEO",
  "Find indexation and metadata blockers.": "Detecta bloqueos de indexacion y metadatos.",
  "Performance Analysis": "Analisis de rendimiento",
  "Catch bottlenecks and Core Web Vitals issues.": "Detecta cuellos de botella y problemas de Core Web Vitals.",
  "Accessibility Scanner": "Escaner de accesibilidad",
  "Detect contrast, focus, and semantic defects.": "Detecta defectos de contraste, foco y semantica.",
  "Mobile Optimization": "Optimizacion mobile",
  "Find broken layouts and interactions on small screens.": "Detecta layouts rotos e interacciones defectuosas en pantallas pequenas.",
  "Security Checks": "Controles de seguridad",
  "Highlight trust and hardening risks.": "Destaca riesgos de confianza y endurecimiento.",
  "UX Improvements": "Mejoras de UX",
  "Prioritize friction that kills conversion.": "Prioriza la friccion que destruye conversion.",
  "Site score": "Puntuacion del sitio",
  "Overall technical quality": "Calidad tecnica general",
  "Speed and stability": "Velocidad y estabilidad",
  "Critical issues": "Problemas criticos",
  "Release blockers": "Bloqueos de release",
  "We moved from debate to release decisions in minutes.": "Pasamos del debate a decisiones de release en minutos.",
  "Head of QA": "Responsable de QA",
  "41% fewer incidents": "41% menos incidentes",
  "We unified QA and SEO in one workflow.": "Unificamos QA y SEO en un solo flujo.",
  "Engineering Manager": "Responsable de ingenieria",
  "2.1x faster validations": "2.1x mas validaciones",
  "Reports are clear for both dev and business.": "Los reportes son claros tanto para dev como para negocio.",
  "Growth Lead": "Responsable de growth",
  "18% higher SEO stability": "18% mas estabilidad SEO",
  "Lead with pain": "Empieza por el problema",
  "Start from current incident and rework cost.": "Parte del incidente actual y del coste de retrabajo.",
...
const caMap: Record<string, string> = {
  ...
  "Technical website audits before release": "Auditories tecniques web abans de cada release",
  "Audit SEO, UX, performance, accessibility, and release risk before every launch.":
    "Audita SEO, UX, rendiment, accessibilitat i risc de release abans de cada publicacio.",
  ...
  "Technical SEO blockers": "Bloquejos de SEO tecnic",
  "Indexation and metadata gaps": "Buits d indexacio i metadades",
  "Users dropping on mobile": "Usuaris que abandonen en mobile",
  "Weak mobile UX hurts retention": "Una UX mobil deficient perjudica la retencio.",
  "Conversion loss per extra second": "Perdua de conversio per cada segon extra",
  "Performance impacts revenue": "El rendiment impacta en ingressos.",
  "SEO Audit": "Auditoria SEO",
  "Find indexation and metadata blockers.": "Detecta bloquejos d indexacio i metadades.",
  "Performance Analysis": "Analisi de rendiment",
  "Catch bottlenecks and Core Web Vitals issues.": "Detecta colls d ampolla i problemes de Core Web Vitals.",
  "Accessibility Scanner": "Escaner d accessibilitat",
  "Detect contrast, focus, and semantic defects.": "Detecta defectes de contrast, focus i semantica.",
  "Mobile Optimization": "Optimitzacio mobile",
  "Find broken layouts and interactions on small screens.": "Detecta layouts trencats i interaccions defectuoses en pantalles petites.",
  "Security Checks": "Controls de seguretat",
  "Highlight trust and hardening risks.": "Destaca riscos de confianca i endureiment.",
  "UX Improvements": "Millores d UX",
  "Prioritize friction that kills conversion.": "Prioritza la friccio que destrossa conversio.",
  "Site score": "Puntuacio del lloc",
  "Overall technical quality": "Qualitat tecnica general",
  "Speed and stability": "Velocitat i estabilitat",
  "Critical issues": "Problemes critics",
  "Release blockers": "Bloquejos de release",
  "We moved from debate to release decisions in minutes.": "Vam passar del debat a decisions de release en minuts.",
  "Head of QA": "Responsable de QA",
  "41% fewer incidents": "41% menys incidencies",
  "We unified QA and SEO in one workflow.": "Vam unificar QA i SEO en un sol flux.",
  "Engineering Manager": "Responsable d enginyeria",
  "2.1x faster validations": "2.1x mes validacions",
  "Reports are clear for both dev and business.": "Els informes son clars tant per dev com per negoci.",
  "Growth Lead": "Responsable de growth",
  "18% higher SEO stability": "18% mes estabilitat SEO",
  "Lead with pain": "Comenca pel problema",
  "Start from current incident and rework cost.": "Parteix de l incidencia actual i del cost de retraball.",
