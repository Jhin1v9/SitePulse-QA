  ...
  return (
    <div className="content-shell min-w-0 space-y-8 py-10 sm:py-14">
      <section className="space-y-3">
        ...
        {sourceTopic ? (
          <p className="text-sm font-medium text-studio-700 dark:text-studio-200">
      ...
      <section className="grid min-w-0 gap-4 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
        <article className="panel min-w-0 p-6">
          ...
          <div className="mt-5 space-y-3 text-sm text-slate-700 dark:text-slate-300">
            <p>
              Sales: <a href={`mailto:${siteConfig.email}`} className="font-semibold text-slate-900 hover:text-studio-700 dark:text-slate-100 dark:hover:text-studio-200">{siteConfig.email}</a>
            </p>
            <p>
              Support: <a href={`mailto:${siteConfig.supportEmail}`} className="font-semibold text-slate-900 hover:text-studio-700 dark:text-slate-100 dark:hover:text-studio-200">{siteConfig.supportEmail}</a>
            </p>
          </div>
        </article>
