...
export default function HomePage({ params }: HomePageProps) {
  ...
  return (
    <div className="content-shell min-w-0 space-y-16 py-10 sm:py-14">
      <section className="grid min-w-0 gap-8 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:items-center">
        <div className="min-w-0 space-y-6">
          ...
          />
          <div className="flex min-w-0 flex-wrap gap-2 text-xs font-semibold uppercase tracking-[0.14em] text-slate-600 dark:text-slate-300">
        ...
        <div className="panel min-w-0 p-5 sm:p-6">
          ...
          <h2 className="mt-2 text-2xl font-semibold text-slate-900 dark:text-slate-100">{messages.home.dashboard.title}</h2>
      ...
      <section className="space-y-5">
        ...
        <h2 className="font-heading text-3xl text-slate-900 dark:text-slate-100">{messages.home.problem.title}</h2>
        ...
        <div className="grid min-w-0 gap-4 md:grid-cols-3">
          {messages.home.problem.stats.map((stat) => (
            <article key={stat.label} className="panel min-w-0 p-5">
      ...
      <section className="grid min-w-0 gap-4 lg:grid-cols-2">
        ...
        <article className="panel min-w-0 p-6 border-studio-400/70">
      ...
      <section className="space-y-5">
        ...
        <h2 className="font-heading text-3xl text-slate-900 dark:text-slate-100">{messages.home.solution.title}</h2>
        ...
        <div className="grid min-w-0 gap-4 lg:grid-cols-3">
          {messages.home.solution.steps.map((step) => (
            <article key={step.title} className="panel min-w-0 p-5">
      ...
      <section className="space-y-5">
        ...
        <h2 className="font-heading text-3xl text-slate-900 dark:text-slate-100">{messages.home.features.title}</h2>
        ...
        <div className="grid min-w-0 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {messages.home.features.items.map((feature) => (
            <article key={feature.title} className="panel min-w-0 p-5">
      ...
      <section className="space-y-5">
        <h2 className="font-heading text-3xl text-slate-900 dark:text-slate-100">{messages.demo.screenshotTitle}</h2>
      ...
      <section className="space-y-5">
        ...
        <h2 className="font-heading text-3xl text-slate-900 dark:text-slate-100">{messages.home.benefits.title}</h2>
      ...
      <section className="space-y-5">
        ...
        <h2 className="font-heading text-3xl text-slate-900 dark:text-slate-100">{messages.home.socialProof.title}</h2>
        ...
        <div className="grid min-w-0 gap-4 lg:grid-cols-3">
          {messages.home.socialProof.quotes.map((quote) => (
            <article key={`${quote.author}-${quote.impact}`} className="panel min-w-0 p-5">
              ...
              <p className="mt-2 text-xs font-semibold uppercase tracking-[0.12em] text-studio-600 dark:text-studio-200">{quote.impact}</p>
            </article>
          ))}
        </div>
      </section>
      ...
      <section className="panel min-w-0 p-6 sm:p-8">
        <h2 className="font-heading text-3xl text-slate-900 dark:text-slate-100">{messages.home.finalCta.title}</h2>
      ...
      <section className="space-y-5 pb-4">
        ...
        <h2 className="font-heading text-3xl text-slate-900 dark:text-slate-100">{messages.home.pricing.title}</h2>
        ...
        <div className="grid min-w-0 gap-4 lg:grid-cols-3">
          {messages.pricing.plans.map((plan) => (
            <article key={plan.id} className={`panel min-w-0 p-5 ${plan.recommended ? "border-studio-400/70" : ""}`}>
              ...
              <h3 className="mt-2 text-2xl font-semibold text-slate-900 dark:text-slate-100">{plan.name}</h3>
