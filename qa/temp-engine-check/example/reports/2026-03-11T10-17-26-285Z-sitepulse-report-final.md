...
- Inicio: 2026-03-11T10:17:23.773Z
- Fim: 2026-03-11T10:17:26.285Z
...
- Status: clean
- Replay command: node src/index.mjs --config "C:\Users\Administrador\Documents\SitePulse-QA\qa\temp-engine-check\example.json" --fresh --live-log --human-log --scope "full" --no-server
- Passo: Sem issues: manter baseline e monitorar regressao.
- Passo: Rodar novamente com: node src/index.mjs --config "C:\Users\Administrador\Documents\SitePulse-QA\qa\temp-engine-check\example.json" --fresh --live-log --human-log --scope "full" --no-server
...
5. [SEO_CANONICAL_MISSING] (low) Link canonical ausente. | recomendacao: Defina canonical para evitar duplicidade de URL.
...
8. [SEO_STRUCTURED_DATA_MISSING] (low) Nenhum JSON-LD encontrado. | recomendacao: Considere schema.org (LocalBusiness, Service, FAQ) para melhorar rich results.
...
Comando de revalidacao: node src/index.mjs --config "C:\Users\Administrador\Documents\SitePulse-QA\qa\temp-engine-check\example.json" --fresh --live-log --human-log --scope "full" --no-server
